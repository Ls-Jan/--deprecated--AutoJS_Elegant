...
var whakeMoles={//打地鼠特攻

    Set_RectViewable:function(flag){},//矩形是否可视
    Set_CornerPoint:function(num,pos){},//设置角点，共两个角点可设置，以控制识别区。如果还传入额外的pos参数(二元列表)的话那么就以该值给角点，否则将使用定位器选定角点
    Opt_Start:function(){},//开锤，锤爆它们





    __locator:tool.Copy.Shallow(require('PosLocator.js')),//定位器，用来选角点
    __cornerPoints:[[0,0],[device.width,device.height]],//角点，拉出一个矩形的
};
